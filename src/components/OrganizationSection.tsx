const OrganizationSection = () => {
  return (
    <section className="p-4 min-h-[60vh] w-full bg-[#E6F2F4] flex flex-col md:flex-row justify-center items-center md:px-24">
      <div className="md:w-1/2 ">
        <img src="/organize.avif" className="shadow-2xl rounded-3xl" />
      </div>
      <div className=" md:w-1/3 flex justify-center items-center md:items-start space-y-4 flex-col my-4">
