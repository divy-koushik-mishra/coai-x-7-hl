...
export const FaqSection = () => {
  return (
    <section data-scroll data-scroll-speed="0.8" className="flex flex-col md:flex-row md:px-24">
      ...
      <div className="md:w-1/2 flex flex-col justify-center p-24 space-y-4">
